...
### Vector Search Public Preview in Azure Cognitive Search
Vector Search is now in Public Preview under [Supplemental Terms of Use](https://azure.microsoft.com/en-us/support/legal/preview-supplemental-terms/), without a service level agreement, and isn't recommended for production workloads.
